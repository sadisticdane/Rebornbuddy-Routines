...
namespace Sadistic
{
    public static class CompositeBuilder
    {
        ...
        public static Composite GetComposite(SadisticRoutine whom, BehaviorType behavior, GameContext context, out int behaviourCount, bool silent = false)
        {
            ...
            if (_methods.Count <= 0)
            {
                ...
                //Logging.Write("Sadistic Behaviors: Added " + _methods.Count + " behaviors");
            }
